...
public:
   ...
   *
   * This function is used by LogicalSigfoxChannelHelper, which computes the time
   ...
   */
  bool BelongsToSubBand (Ptr<LogicalSigfoxChannel> channel);
