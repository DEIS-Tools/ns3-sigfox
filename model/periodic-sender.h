...
public:
  ...
  /**
   * Send a packet using the SigfoxNetDevice's Send method
   */
  void SendPacket (void);

  int Sendfrequency (void);
  /**
  ...
  void StopApplication (void);
    //int sendcnt=0;
    /**
     * Select Transmission Strategy
     */
    void SelectTransmissionStrategy (uint8_t  SelectStrategy);
    void SelectBiDirectionalProcedureFrequency(uint8_t BDPF);
    
    void EnableSendingData(void);  // for Data Compression Strategy
    void EnableSendingWeather (void); // for Weather Driven Strategy
private:
  /**
  ...
  uint8_t m_basePktSize;
    ...
    bool EnableWeatherModel = false;
    bool EnableDataModel = false;
  /**
