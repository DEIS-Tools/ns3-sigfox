...
public:
  ...
  /**
   * Create a SigfoxTag with a given spreading factor and collision.
   *
  ...
  /**
   * Set the frequency of the packet, in Hz.
   *
  ...
  void SetRepetitionNumber (uint8_t rep);

  uint8_t GetRepetitionNumber (void);
...
private:
  ...
  double m_durationSeconds; //!< The duration of this packet
  uint8_t m_repNumber;
