 ...
 * SigfoxNetDevice -> PointToPointNetDevice and vice versa.
 */
...
public:
   ...
   *
   * \param sigfoxNetDevice The SigfoxNetDevice on this node.
   */
  void SetSigfoxNetDevice (Ptr<SigfoxNetDevice> sigfoxNetDevice);
  ...
  /**
   * Receive a packet from the SigfoxNetDevice.
   *
   * \param sigfoxNetDevice The SigfoxNetDevice we received the packet from.
   ...
   */
  bool ReceiveFromSigfox (Ptr<NetDevice> sigfoxNetDevice, Ptr<const Packet> packet,
...
private:
  Ptr<SigfoxNetDevice> m_sigfoxNetDevice; //!< Pointer to the node's SigfoxNetDevice
