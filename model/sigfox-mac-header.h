...
#ifndef SIGFOX_MAC_HEADER_H
#define SIGFOX_MAC_HEADER_H
...
/**
 * This class represents the Mac header of a Sigfox packet.
 */
class SigfoxMacHeader : public Header
{
public:
  /**
   * The message type.
   ...
   *
   * See Page 15 of Sigfox specification for a representation of fields.
   *
