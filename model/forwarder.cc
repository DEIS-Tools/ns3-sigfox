...
void
Forwarder::SetSigfoxNetDevice (Ptr<SigfoxNetDevice> sigfoxNetDevice)
{
  NS_LOG_FUNCTION (this << sigfoxNetDevice);

  m_sigfoxNetDevice = sigfoxNetDevice;
}

bool
Forwarder::ReceiveFromSigfox (Ptr<NetDevice> sigfoxNetDevice, Ptr<const Packet>
                                    ...
                                    const Address& sender)
{
  ...
  m_sigfoxNetDevice->Send (packetCopy);
